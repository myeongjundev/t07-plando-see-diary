...
export default function ExportPanel({ id }: ExportPanelProps = {}) {
  ...
  return <section className="panel export-panel" id={id}>
    <div className="section-heading"><div><span>02</span><h2>내 자료 내보내기</h2></div><p>계획부터 회고까지 한 파일에 보관합니다.</p></div>
